...
import img3 from '../assets/Images/9.webp';
import img4 from '../assets/Images/10.webp';
  ...
  return (
    <Section  ref={ref} id="fixed-target" className="new-arrival">
      ...
      <Container ref={ScrollingRef}>
        <Photos img={img1} name="Chesapeake,VA" />
        <Photos img={img2} name="Chesapeake,VA" />
        <Photos img={img3} name="Chesapeake,VA" />
        <Photos img={img4} name="Chesapeake,VA" />
      </Container>
